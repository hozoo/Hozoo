...
echo "\033[37;1m[] AUTHOR : HOZOO                          []"|lolcat
echo "\033[35;1m[] W A    :+628999859595                          []"|lolcat
echo "\033[36;1m[] NO HP  :+628999859595                              []"|lolcat
echo "\033[31;1m[] PESAN  : jangan lupa follow tik tok HACKERSHOZOORAFI 🥵 ajarin sepuh pemograman tar saya buat ddos attack servers lebih drak 🥵 🥵           []"|lolcat
echo "\033[36;1m[]=====================================================[]"|lolcat
...
echo $green"          <©>=========================<®>"
echo $red"          ( 22 ) FOLLOW TIK TOK HACKERSHOZOORAFI"|lolcat
echo $red"          <©>=========================<®>"
...
then
clear
('xdg-open https://www.tiktok.com/@hackershozoo?_t=8fpzKaRGxvO&_r=1')
cd SYTD
python sytd.py
fi
